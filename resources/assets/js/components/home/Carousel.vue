...
export default {
    ...
    data: () => ({
        images: [
            ...
            {src: '/img/checkoutprocess.png', headline: 'Easy Shopping Experience', subheader: 'So Many Ways To Pay, Credit Card, Online Payment, Bank Deposit and COD', 'buttontext': 'Shop Now', 'buttonlink': '/products', 'icon': 'fa-shopping-bag '},
