...
var _guard = __webpack_require__(661);
...
exports.default = {
    mixins: [_theme2.default, _guard2.default],
    data: function data() {
        return {
            contentClass: { 'grey': true, 'lighten-4': true, 'accent--text': true },
            categories: [],
