...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-72583948", Component.options)
  } else {
    hotAPI.reload("data-v-72583948", Component.options)
  }
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                self = _this;
                                slug = { slug: self.$route.params.slug };
                                _context.next = 4;
                                return axios.get(route('api.category.show', slug) + '/?page=' + self.page).then(function (response) {
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                              ...
                              directives: [
                                {
                                  ...
                                  rawName: "v-tooltip:right",
                                  value: {
                                    html: "View Details of " + product.name
                                  },
                                  expression:
                                    "{ html: `View Details of ${product.name}` }",
                                  arg: "right"
                            ...
                            [
                              _c("v-icon", { staticClass: "info--text" }, [
                                  ...
                                  directives: [
                                    {
                                      ...
                                      value: {
                                        html:
                                          "Remove " + product.name + " in cart"
                                      },
                                      expression:
                                        "{ html: `Remove ${product.name} in cart` }",
                                      arg: "left"
                                    }
                                  ],
                                  attrs: { icon: "" },
                                  ...
                                  directives: [
                                    {
                                      ...
                                      expression:
                                        "{ html: `View Item in Cart | ${product.name} qty : ${product.qty}` }",
                                      arg: "left"
                                    }
                                  ],
                                  attrs: { icon: "" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-72583948", module.exports)
  }
}
