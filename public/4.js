...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_theme__ = __webpack_require__(652);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mixins_acl__ = __webpack_require__(804);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__partials_DashPanels_vue__ = __webpack_require__(805);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_dashboard_CustomerDetails_vue__ = __webpack_require__(813);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_dashboard_PaymentDetails_vue__ = __webpack_require__(818);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_dashboard_ShippingDetails_vue__ = __webpack_require__(823);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            current_order: {},
            /* tabs */
            tabs: [{ name: 'order details', component: 'cart-details' }, { name: 'customer details', component: 'customer-details' }, { name: 'shipping details', component: 'shipping-details' }, { name: 'payment', component: 'payment-details' }],
            active: {
                name: 'order details'
            }
    ...
    methods: {
        ...
        setCurrentOrder: function setCurrentOrder(order) {
            ...
            this.tabs = [__WEBPACK_IMPORTED_MODULE_0_C_Users_uriah_sites_www_shop_node_modules_babel_runtime_core_js_object_assign___default()({ name: 'customer details', component: 'customer-details' }, JSON.parse(this.current_order.customer_details)), __WEBPACK_IMPORTED_MODULE_0_C_Users_uriah_sites_www_shop_node_modules_babel_runtime_core_js_object_assign___default()({ name: 'shipping details', component: 'shipping-details' }, this.current_order.shipment), __WEBPACK_IMPORTED_MODULE_0_C_Users_uriah_sites_www_shop_node_modules_babel_runtime_core_js_object_assign___default()({ name: 'payment details', component: 'payment-details' }, this.current_order.payment)];
        },
      ...
      _c(
        ...
        [
          _c(
            ...
            [_c("p", [_vm._v(_vm._s(_vm.tab.name))])]
          )
        ],
        1
      )
