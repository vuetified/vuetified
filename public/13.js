...
var render = function() {
  ...
  return _c(
    ...
    [
      !_vm.checkMeOutForm.busy
        ? _c(
            "v-card",
            [
              _c("v-card-title", { staticClass: "headline error--text" }, [
                _vm._v("What Do You Want To Use For Checkout?")
              ]),
              _vm._v(" "),
              _c("v-card-text", [
                _c("strong", { staticClass: "green--text" }, [
                  _vm._v("Checkmeout.ph")
                ]),
                _vm._v(" - For COD, Credit Card, and Online Banking ")
              ]),
              _vm._v(" "),
              _c("v-card-text", [
                _c("strong", { staticClass: "blue--text text--darken-2" }, [
                  _vm._v("Checkout")
                ]),
                ...
                [
                  ...
                  _c(
                    "v-btn",
                    {
                      attrs: {
                        color: "primary",
                        disabled: _vm.checkMeOutForm.busy,
                        flat: ""
                      },
                      on: { click: _vm.checkMeOut }
                    },
                    [_c("img", { attrs: { src: "/img/checkmeout.png" } })]
                  ),
                  _vm._v(" "),
                  _c(
                    "v-btn",
        ...
        : _c(
            ...
            [
              _c(
                "v-card-title",
                { staticClass: "text-xs-center headline info--text" },
                [_vm._v("Processing Orders, Please Wait...")]
              ),
              _vm._v(" "),
              _c(
                "v-card-text",
